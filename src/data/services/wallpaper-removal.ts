...
const data: ServicePageData = {
  ...
  "titleTag": "Wallpaper Removal Los Angeles | Red Stag",
  "metaDescription": "Wallpaper Removal in Los Angeles. $400-$900 1 room, $2,500-$6,500+ larger scopes. Free walkthrough today.",
  "h1": "Wallpaper Removal in Los Angeles",
  "primaryKeyword": "wallpaper removal Los Angeles",
  "secondaryKeywords": [
    "wallpaper removal near me",
    "wallpaper removal cost LA",
    "best wallpaper removal Los Angeles",
    "wallpaper removal contractor Los Angeles"
  ],
  ...
  "faqs": [
    {
      "question": "How much does wallpaper removal cost in Los Angeles?",
      "answer": "Wallpaper Removal in Los Angeles usually starts around $400 to $900 for 1 room work. Larger jobs typically land around $2,500 to $6,500+. Prep level, access, and surface condition are what move the number."
    },
    {
      "question": "How long does a wallpaper removal job usually take?",
      "answer": "One feature wall can turn in a day. Full-room removals with glue cleanup and skim work often need 2 to 3 working days before they are truly ready for paint."
    },
    {
      "question": "What prep is actually included before you paint or refinish?",
      "answer": "We include the prep steps that make the finish hold: soften and strip paper without gouging the wall, wash or scrape off adhesive residue, skim damaged areas and sand flat, prime before the finish color goes on. We do not skip those steps to make the quote look cheaper."
    },
    {
      "question": "What usually makes wallpaper removal prices jump higher than expected?",
    ...
    {
      "question": "Is wallpaper removal worth doing instead of replacing everything?",
      "answer": "Wallpaper removal only pays off when the wall is paint-ready afterward. The adhesive and the torn paper face are what make cheap removals fail. If the material is still sound, keeping the bones and paying for careful prep usually gives homeowners the best return."
    }
  ],
  "relatedServices": [
