...
const data: ServicePageData = {
  ...
  "titleTag": "Drywall Repair & Paint Los Angeles | Red Stag",
  "metaDescription": "Drywall Repair & Paint in Los Angeles. $400-$900 1 room, $2,500-$6,500+ larger scopes. Free walkthrough today.",
  "h1": "Drywall Repair & Paint in Los Angeles",
  "primaryKeyword": "drywall repair & paint Los Angeles",
  "secondaryKeywords": [
    "drywall repair & paint near me",
    "drywall repair & paint cost LA",
    "best drywall repair & paint Los Angeles",
    "drywall repair & paint contractor Los Angeles"
  ],
  ...
  "faqs": [
    {
      "question": "How much does drywall repair & paint cost in Los Angeles?",
      "answer": "Drywall Repair & Paint in Los Angeles usually starts around $400 to $900 for 1 room work. Larger jobs typically land around $2,500 to $6,500+. Prep level, access, and surface condition are what move the number."
    },
    {
      "question": "How long does a drywall repair & paint job usually take?",
      "answer": "Minor repairs can be turned in a day. Multi-room patching with drying cycles usually takes 2 to 4 days before the finish looks consistent."
    },
    {
      "question": "What prep is actually included before you paint or refinish?",
      "answer": "We include the prep steps that make the finish hold: cut out loose material and secure the field, tape, mud, and sand in the right sequence, feather wide enough that the repair disappears, prime every repair before finish paint. We do not skip those steps to make the quote look cheaper."
    },
    {
      "question": "What usually makes drywall repair & paint prices jump higher than expected?",
    ...
    {
      "question": "Is drywall repair & paint worth doing instead of replacing everything?",
      "answer": "Doing drywall repair and paint as one scope prevents the classic problem where a wall patch looks fine at noon and obvious at sunset. If the material is still sound, keeping the bones and paying for careful prep usually gives homeowners the best return."
    }
  ],
  "relatedServices": [
    "interior-painting",
