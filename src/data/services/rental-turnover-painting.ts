...
const data: ServicePageData = {
  ...
  "titleTag": "Rental Turnover Painting LA | Red Stag",
  "metaDescription": "Rental Turnover Painting in Los Angeles. $400-$900 1 room, $2,500-$6,500+ larger scopes. Free walkthrough today.",
  "h1": "Rental Turnover Painting in Los Angeles",
  "primaryKeyword": "rental turnover painting Los Angeles",
  "secondaryKeywords": [
    "rental turnover painting near me",
    "rental turnover painting cost LA",
    "best rental turnover painting Los Angeles",
    "rental turnover painting contractor Los Angeles"
  ],
  ...
  "faqs": [
    {
      "question": "How much does rental turnover painting cost in Los Angeles?",
      "answer": "Rental Turnover Painting in Los Angeles usually starts around $400 to $900 for 1 room work. Larger jobs typically land around $2,500 to $6,500+. Prep level, access, and surface condition are what move the number."
    },
    {
      "question": "How long does a rental turnover painting job usually take?",
      "answer": "Simple vacant turns can be wrapped in 1 to 2 days. Multi-room units with patching, stains, and ceilings usually land at 2 to 4 days."
    },
    {
      "question": "What prep is actually included before you paint or refinish?",
      "answer": "We include the prep steps that make the finish hold: walk the unit and separate touch-up from full repaint work, patch and sand high-wear damage, prime stains and heavy scuff zones, use durable colors that are easy to maintain on the next turn. We do not skip those steps to make the quote look cheaper."
    },
    {
      "question": "What usually makes rental turnover painting prices jump higher than expected?",
    ...
    {
      "question": "Is rental turnover painting worth doing instead of replacing everything?",
      "answer": "Turnover painting is about speed with standards. The unit has to show clean on day one and still look clean after the next tenant moves furniture in. If the material is still sound, keeping the bones and paying for careful prep usually gives homeowners the best return."
    }
  ],
  "relatedServices": [
