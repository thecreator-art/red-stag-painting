...
const data: ServicePageData = {
  ...
  "titleTag": "Trim & Baseboard Painting LA | Red Stag",
  "metaDescription": "Trim & Baseboard Painting in Los Angeles. $400-$900 1 room, $2,500-$6,500+ larger scopes. Free walkthrough today.",
  "h1": "Trim & Baseboard Painting in Los Angeles",
  "primaryKeyword": "trim & baseboard painting Los Angeles",
  "secondaryKeywords": [
    "trim & baseboard painting near me",
    "trim & baseboard painting cost LA",
    "best trim & baseboard painting Los Angeles",
    "trim & baseboard painting contractor Los Angeles"
  ],
  ...
  "faqs": [
    {
      "question": "How much does trim & baseboard painting cost in Los Angeles?",
      "answer": "Trim & Baseboard Painting in Los Angeles usually starts around $400 to $900 for 1 room work. Larger jobs typically land around $2,500 to $6,500+. Prep level, access, and surface condition are what move the number."
    },
    {
      "question": "How long does a trim & baseboard painting job usually take?",
      "answer": "Single-room trim packages can turn in a day. Whole-house trim with doors and crown usually takes 2 to 4 days."
    },
    {
      "question": "What prep is actually included before you paint or refinish?",
      "answer": "We include the prep steps that make the finish hold: degloss and sand the profile, caulk gaps and fill dents, spot-prime stained or bare wood, mask floors and hinges cleanly. We do not skip those steps to make the quote look cheaper."
    },
    {
      "question": "What usually makes trim & baseboard painting prices jump higher than expected?",
    ...
    {
      "question": "Is trim & baseboard painting worth doing instead of replacing everything?",
      "answer": "Fresh trim makes old wall paint look cleaner and expensive millwork look intentional again. It is one of the fastest ways to tighten a room. If the material is still sound, keeping the bones and paying for careful prep usually gives homeowners the best return."
    }
  ],
  "relatedServices": [
    "interior-painting",
