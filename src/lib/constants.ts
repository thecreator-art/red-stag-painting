...
export const PROJECTS: Project[] = [
  {
    ...
    city: 'Illustrative reference',
    description: 'Stock reference pair showing the kind of visual lift a warm-white repaint can create in a tired living space.',
  },
  {
    ...
    city: 'Illustrative reference',
    description: 'Stock reference pair for exterior repaint direction, showing the jump from weathered stucco to a cleaner high-contrast finish.',
  },
  {
    ...
    city: 'Illustrative reference',
    description: 'Stock reference pair showing how dark, heavy cabinetry can read brighter and more current after a sprayed cabinet finish.',
  },
  {
    ...
    serviceType: 'Drywall Repair & Paint',
    city: 'Illustrative reference',
    description: 'Stock reference pair for patch-and-paint work, showing the difference between visible repair scars and a flatter finished wall.',
  },
  {
    ...
    serviceType: 'Exterior Painting',
    city: 'Illustrative reference',
    description: 'Stock reference pair for a higher-end exterior look, useful for showing trim contrast, body color cleanup, and curb appeal lift.',
  },
  {
    ...
    city: 'Illustrative reference',
    description: 'Stock reference pair showing the cleaner look homeowners expect after popcorn texture removal and a fresh ceiling topcoat.',
  },
];
